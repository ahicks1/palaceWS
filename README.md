...
The messages are defined using json schema and validated using AJV (Another JSON validator)
...
### Documentation
The documentation is auto-generated by jsdoc. To regenerate the docs run `npm run mkdocs`.
